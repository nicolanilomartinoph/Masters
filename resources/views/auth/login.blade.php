            ...
            <div class="w-100"></div>
                <div class="col-5 justify-content-center">
                    <form class="row mt-lg-5 mt-1" method="POST" action="{{ route('login') }}">
                        ...
                        @enderror
                        <input type="password" placeholder="Password" class="col-12 my-3 form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" 
                        required autocomplete="email" autofocus id="passwordInput"></input>
